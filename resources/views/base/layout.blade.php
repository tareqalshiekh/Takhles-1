                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                            <img src="{{ URL::asset('assets/images/logo-srm.png')}}" alt="" height="22">
                        </span>
                            <span class="logo-lg">
                            <img src="{{ URL::asset('assets/images/logo-lighrt.png')}}" alt="" height="20">
                        </span>
                        </a>
                    </div>
                    ...
                    <div class="dropdown d-none d-md-block ms-2">
                      ...
                      Language
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <!-- item-->
                            <a href="{{'dashboard_ar'}}" class="dropdown-item notify-item">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="{{'products'}}">Add New Products</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{'all_banner'}}">All Banners</a></li>
                                <li><a href="{{'banner'}}">Add New Banner</a></li>
                            </ul>
                        </li>
